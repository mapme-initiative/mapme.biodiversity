...
represents "tree cover in the year 2000, defined as canopy closure for
all vegetation taller than 5m in height. Encoded as a percentage per
output grid cell, in the range 0–100." Due to changes in the satellites
products used in the compilation of the treecover product, results
before the year 2011 and afterwards are not directly comparable until
reprocessing has finished. Users should be aware of this limitation,
...
- version:
  ...
  Check mapme.biodiversity:::.available_gfw_versions() to get a list of
  available versions
