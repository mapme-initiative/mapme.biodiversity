...
gdal_s3_opts <- function(...) {
  user_opts <- list(...)
  defaults <- list("AWS_NO_SIGN_REQUEST" = "YES",
                ...
                "AWS_HTTPS" = "YES",
                "AWS_VIRTUAL_HOSTING" = "YES",
                "VSIS3_CHUNK_SIZE" = "50",
                "CPL_VSIL_CURL_IGNORE_GLACIER_STORAGE" = "YES",
                "CPL_VSIL_CURL_IGNORE_STORAGE_CLASSES" = "GLACIER\\,DEEP_ARCHIVE",
                "CPL_VSIS3_USE_BASE_RMDIR_RECURSIVE" = "NO",
                "CPL_VSIS3_CREATE_DIR_OBJECT" = "YES")
  .match_opts(user_opts, defaults)
}

gdal_gcs_opts <- function(...){
  user_opts <- list(...)
  defaults <- list("GS_NO_SIGN_REQUEST" = "YES",
...
gdal_az_opts <- function(...){
  user_opts <- list(...)
  defaults <- list("AZURE_NO_SIGN_REQUEST" = "YES",
