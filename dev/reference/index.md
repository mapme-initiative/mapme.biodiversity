...
- [`get_fritz_et_al()`](https://mapme-initiative.github.io/mapme.biodiversity/dev/reference/fritz_et_al.md)
...
- [`get_global_surface_water_change()`](https://mapme-initiative.github.io/mapme.biodiversity/dev/reference/global_surface_water_change.md)
  : Global Surface Water Change
- [`get_global_surface_water_occurrence()`](https://mapme-initiative.github.io/mapme.biodiversity/dev/reference/global_surface_water_occurrence.md)
  : Global Surface Water Occurrence
- [`get_global_surface_water_recurrence()`](https://mapme-initiative.github.io/mapme.biodiversity/dev/reference/global_surface_water_recurrence.md)
  : Global Surface Water Recurrence
- [`get_global_surface_water_seasonality()`](https://mapme-initiative.github.io/mapme.biodiversity/dev/reference/global_surface_water_seasonality.md)
  : Global Surface Water Seasonality
- [`get_global_surface_water_transitions()`](https://mapme-initiative.github.io/mapme.biodiversity/dev/reference/global_surface_water_transitions.md)
  : Global Surface Water Transitions
- [`get_gmw()`](https://mapme-initiative.github.io/mapme.biodiversity/dev/reference/gmw.md)
...
- [`get_gsw_time_series()`](https://mapme-initiative.github.io/mapme.biodiversity/dev/reference/gsw_time_series_resource.md)
  : Helper function to download Global Surface Water (GSW) yearly time
  series data
...
- [`get_mcd64a1()`](https://mapme-initiative.github.io/mapme.biodiversity/dev/reference/mcd64a1.md)
  : MODIS Burned Area Monthly (MCD64A1)
- [`get_nasa_grace()`](https://mapme-initiative.github.io/mapme.biodiversity/dev/reference/nasa_grace.md)
...
- [`get_soilgrids()`](https://mapme-initiative.github.io/mapme.biodiversity/dev/reference/soilgrids.md)
...
- [`get_worldclim_max_temperature()`](https://mapme-initiative.github.io/mapme.biodiversity/dev/reference/worldclim_max_temperature.md)
  : Downloads WorldClim Maximum Temperature layer
- [`get_worldclim_min_temperature()`](https://mapme-initiative.github.io/mapme.biodiversity/dev/reference/worldclim_min_temperature.md)
  : Downloads WorldClim Minimum Temperature layer
- [`get_worldclim_precipitation()`](https://mapme-initiative.github.io/mapme.biodiversity/dev/reference/worldclim_precipitation.md)
  : Downloads WorldClim Mean Precipitation layer
- [`get_worldpop()`](https://mapme-initiative.github.io/mapme.biodiversity/dev/reference/worldpop.md)
...
- [`calc_biome()`](https://mapme-initiative.github.io/mapme.biodiversity/dev/reference/biome.md)
  : Calculate biomes statistics (TEOW) based on WWF
- [`calc_burned_area()`](https://mapme-initiative.github.io/mapme.biodiversity/dev/reference/burned_area.md)
...
- [`calc_drought_indicator()`](https://mapme-initiative.github.io/mapme.biodiversity/dev/reference/drought_indicator.md)
  : Calculate drought indicator statistics
- [`calc_ecoregion()`](https://mapme-initiative.github.io/mapme.biodiversity/dev/reference/ecoregion.md)
...
- [`calc_gsw_change()`](https://mapme-initiative.github.io/mapme.biodiversity/dev/reference/gsw_change.md)
  : Calculate Global Surface Water (GSW) Change
- [`calc_gsw_occurrence()`](https://mapme-initiative.github.io/mapme.biodiversity/dev/reference/gsw_occurrence.md)
  : Calculate Global Surface Water (GSW) Occurrence
- [`calc_gsw_recurrence()`](https://mapme-initiative.github.io/mapme.biodiversity/dev/reference/gsw_recurrence.md)
  : Calculate Global Surface Water (GSW) Recurrence
- [`calc_gsw_seasonality()`](https://mapme-initiative.github.io/mapme.biodiversity/dev/reference/gsw_seasonality.md)
...
- [`calc_gsw_transitions()`](https://mapme-initiative.github.io/mapme.biodiversity/dev/reference/gsw_transitions.md)
...
- [`calc_landcover()`](https://mapme-initiative.github.io/mapme.biodiversity/dev/reference/landcover.md)
...
- [`calc_population_count()`](https://mapme-initiative.github.io/mapme.biodiversity/dev/reference/population_count.md)
...
- [`calc_precipitation_wc()`](https://mapme-initiative.github.io/mapme.biodiversity/dev/reference/precipitation_wc.md)
  : Calculate precipitation statistics
- [`calc_slope()`](https://mapme-initiative.github.io/mapme.biodiversity/dev/reference/slope.md)
  : Calculate slope statistics
- [`calc_soilproperties()`](https://mapme-initiative.github.io/mapme.biodiversity/dev/reference/soilproperties.md)
...
- [`calc_temperature_max_wc()`](https://mapme-initiative.github.io/mapme.biodiversity/dev/reference/temperature_max_wc.md)
  : Calculate maximum temperature statistics
- [`calc_temperature_min_wc()`](https://mapme-initiative.github.io/mapme.biodiversity/dev/reference/temperature_min_wc.md)
  : Calculate minimum temperature statistics based on WorldClim
- [`calc_traveltime()`](https://mapme-initiative.github.io/mapme.biodiversity/dev/reference/traveltime.md)
