test_that("worldclim precipitation works", {
  ...
  expect_error(
    .calc_worldclim_precipitation(shp, precipitation, engine = "not-available"),
    "Engine 'not-available' is not an available engine. Please choose one of:"
  )
  expect_error(
    .calc_worldclim_precipitation(shp, precipitation, stats_precipitation = "not-available"),
  ...
  expect_snapshot(
    .calc_worldclim_precipitation(shp, precipitation, stats_precipitation = c("mean", "median", "sd"))
  )
  expect_snapshot(
