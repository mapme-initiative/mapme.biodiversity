test_that("worldclim minimum temperature works", {
  ...
  expect_error(
    .calc_worldclim_mintemperature(shp, mintemperature, engine = "not-available"),
    "Engine 'not-available' is not an available engine. Please choose one of:"
  )
  expect_error(
    .calc_worldclim_mintemperature(shp, mintemperature, stats_mintemperature = "not-available"),
  ...
  expect_snapshot(
    .calc_worldclim_mintemperature(shp, mintemperature, stats_mintemperature = c("mean", "median", "sd"))
  )
  expect_snapshot(
