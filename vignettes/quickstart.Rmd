...
If you wish to conduct your statistical analysis in R, you can use `portfolio_long()`
and `portfolio_wide()` to change the data layout (see the respective [online tutorial](file:///home/darius/Documents/git-repos/mapme/mapme.biodiversity/docs/articles/output-wide.html)). 
...
portfolio_long(aoi_gridded, drop_geoms = TRUE)
```
...
(portfolio_from_disk <- st_read(tmp_output))
```
