...
Let's inspect the names of this list to learn which resources are available.
...
<code>available_indicators()</code> function.
...
either of the below commands or, if you are viewing the online version, head
...
Let's quickly visualize the results a single asset
...
sample_portfolio %>%
  ...
  labs(title = "Monthly precipitation anomaly 2010", x = "Month", y = "Precipitation anomaly [mm]",
       fill = "Anomaly") +
  theme_classic() +
