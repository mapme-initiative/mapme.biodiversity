...
internally. Many organizations provide and continue to provide value-added
...
4.  write the resulting to disk as a GeoPackage and share or use in other Geo-Spatial software, or
...
does not pose any limitations. However, if the data was to be shared
to use it in other geospatial software, a routine to write a portfolio object
as a GeoPackage is provided. Each indicator will be written to an independent table and
